...
class QRController {
    ...
    async generateQR(req, res) {
        try {
            ...
            const callbackUrl = requestedCallbackUrl || `http://150.95.31.23:8026/api/v1/direct/callback`;
    ...
    async handleCallback(req, res) {
        try {
            ...
            logger.info(`Received payment callback: ${JSON.stringify(callbackData)} | Query: ${JSON.stringify(req.query)} | Headers: ${JSON.stringify(req.headers)}`);
